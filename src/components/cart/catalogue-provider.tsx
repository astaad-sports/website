 ...
 * show current prices and stock in the browser. The cart and checkout pages
 * wrap their views in another provider with a catalogue read fresh from the
 * database (the nearest provider wins); placing the order prices it again on
 * the server.
 */
