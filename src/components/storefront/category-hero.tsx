...
/**
 * The black category stage: breadcrumb, display title, tagline and the cut-out
 * under the floodlight. `from` is the lowest price on sale, or null while the
 * category has nothing on sale; the stats then say it is coming soon.
 */
