...
/**
 * An unknown or deleted offer. Admins get a way back to Offers; anyone else
  ...
  return (
    <main className={cn(PAGE, "pt-1 lg:pt-6")}>
      ...
      <div className="flex flex-col items-center gap-2 border-y border-border py-12 text-center">
        <BadgePercent className="size-8 text-ink-muted" strokeWidth={1.5} aria-hidden="true" />
        <h1 className="text-base leading-[22px] font-semibold">This offer doesn&apos;t exist</h1>
        <p className="text-[13px] leading-[18px] text-ink-muted">It may have been deleted. Find it in Offers.</p>
        <Link href="/admin/offers" className={cn(BUTTON_SECONDARY, "mt-2")}>
          Show all offers
        </Link>
      </div>
    </main>
